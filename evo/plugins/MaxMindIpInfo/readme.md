...
Вы всегда можете обновить базу IP просто скачав файлы с официального сайта https://dev.maxmind.com/geoip/geoip2/geolite2/#Downloads
просто следите за тем чтоб файлы назывались так как это указано в коде. Загружать их надо в папку **assets/plugins/MaxMindIpInfo/data**
...
Данный плагин не тестировался c REVO, но вероятно тоже будет работать, т.к. там нет противоречий.
