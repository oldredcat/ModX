...
Пока в плане сделать связку окато/октмо по ip населенного пункта (а есть ещё фиас... правда там тоже самое что октмо/окато), если есть.<br>
А то этого реально нету.
Для Битрикса есть и то только за полтинник!<br>
ГО ВМЕСТЕ СДЕЛАЕМ ДЛЯ **НЕ БИТРИКСА** И ПЛЮНЕМ В НИХ БОЛЬШОЙ КАЗЯВКОЙ!!!)))
